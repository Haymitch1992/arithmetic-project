...
export default {
    ...
    methods: {
        dragLinkPath() {
            ...
            if (this.isVertical()) {
                return `M ${fromX} ${fromY}  Q ${fromX} ${fromY + 50} ${(toX +
                    fromX) /
                    2} ${(fromY + toY) / 2} T ${toX} ${toY}`;
            } else {
                return `M ${fromX} ${fromY} Q ${fromX + 30} ${fromY}  ${(toX +
                    fromX) /
                    2} ${(fromY + toY) / 2} T ${toX} ${toY}`;
            }
        },
        computedArrow() {
            ...
            if (this.isVertical()) {
                return `${toX} ${toY} ${toX - 3} ${toY - 6} ${toX + 3} ${toY -
                    6}`;
            } else {
                return `${toX - 3} ${toY + 3} ${toX} ${toY} ${toX - 3} ${toY -
                    3}`;
            }
        },
        isVertical() {
