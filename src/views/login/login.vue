<template>
    <div class="bg">
        <div class="login-box">
            ...
            <div class="login-container">
                ...
                <el-form ref="form" :model="form" :rules="rules">
                    ...
                    <el-form-item prop="data_user_password">
                        <el-input
                            ...
                            type="password"
                            v-model="form.data_user_password"
                            placeholder="密码"
                            show-password
                        ></el-input>
                    </el-form-item>
                ...
                <div>
                    <el-button
                        type="text"
                        @click.native="$router.push('/forget')"
                    >
                        忘记密码
                    </el-button>
                    <el-button
        ...
        <p class="copyright">copyright © 2020交控科技股份有限公司 & 数据智能</p>
        <div class="slide-bg" v-show="slideShow">
            <div class="slide-box">
                <div style="text-align: right;padding-bottom: 10px">
                    <el-button @click.native="slideShow = fasle">
                        关闭
                    </el-button>
                </div>
                ...
                .then(res => {
                    ...
                    if (res.data.code === 200) {
                        localStorage.setItem(
                            'data_user_id',
                            res.data.data_user_id
                        );
                        localStorage.setItem(
                            'data_user_token',
                            res.data.data_user_token
                        );
                        this.$store.commit(
                            'changeUserName',
                            res.data.data_user_name
                        );
                        this.$store.commit(
                            'changeUserEmail',
                            res.data.data_user_email
                        );
