    ...
    methods: {
        ...
        run() {
            ...
            for (let i = 0; i < nodeArr.length; i++) {
                switch (nodeArr[i].name) {
                    case "数据集":
                        this.runArr[0] = nodeArr[i];
                        break;
                    case "拆分":
                        this.runArr[1] = nodeArr[i];
                        break;
                    case "分类-KNN-2":
                        this.runArr[2] = nodeArr[i];
                        break;
                    case "模型测试":
                        this.runArr[3] = nodeArr[i];
                        break;
                    case "分类评估":
                        this.runArr[4] = nodeArr[i];
                        break;
                }
            }
        ...
        runAto1() {
            ...
            this.$api
                .post(POST_RUN_MODEL, {
                    ...
                    node_id: this.runArr[0].id,
                    node_name: this.runArr[0].name,
                    component_id: "load_data",
                    component_name: this.runArr[0].name,
                    node_params: {
                        csv_name: this.runArr[0].form[0].data[0].value
                            .node_params.csv_name,
                        download_path: this.runArr[0].form[0].data[0].value
                            .node_params.download_path
                    },
                    edge_in: [],
                    edge_out: ["csv_path>dataset_path"],
                    input: {},
                ...
                .then(res => {
                    ...
                    if (res.data.code === 200) {
                        ...
                        this.runArr[0].output = res.data.output;
                        this.runArr[0].artifact_path = res.data.run_uuid;
                        this.postNodeParameter(res.data.run_uuid, {
                            csv_name: this.runArr[0].form[0].data[0].value
                                .node_params.csv_name,
                            download_path: this.runArr[0].form[0].data[0].value
                                .node_params.download_path
                        ...
                        this.$message.success(
                            this.runArr[this.currentNodeNum - 1].name
                        );
                        this.runAto2();
                    }
                });
        ...
        runAto2() {
            this.$api
                .post(POST_RUN_MODEL, {
                    ...
                    experiment_id: this.data_test_id + "",
                    experiment_name: "switch_machine_test2",
                    node_id: this.runArr[1].id,
                    node_name: this.runArr[1].name,
                    component_id: "standard_scale",
                    component_name: this.runArr[1].name,
                    node_params: {
                        select_columns: this.runArr[1].form[0].data[0].value.node_params.select_features_columes.join(
                            ","
                        )
                    },
                    edge_in: ["csv_path>dataset_path"],
                    edge_out: ["input_data_standard_scale>dataset_path"],
                    input: this.runArr[0].output,
                    pre_run_uuids: [this.runArr[0].artifact_path],
                    is_generate_model: "false"
                })
                .then(res => {
                    this.currentNodeNum++;
                    if (res.data.code === 200) {
                        ...
                        this.runArr[1].output = res.data.output;
                        this.runArr[1].artifact_path = res.data.run_uuid;
                        this.postNodeParameter(res.data.run_uuid, {
                            csv_name: this.runArr[1].form[0].data[0].value
                                .node_params.csv_name,
                            download_path: this.runArr[1].form[0].data[0].value
                                .node_params.download_path
                        });
                        this.$message.success(
                            this.runArr[this.currentNodeNum - 1].name
        ...
        runAto3() {
            this.$api
                .post(POST_RUN_MODEL, {
                    ...
                    experiment_id: this.data_test_id + "",
                    experiment_name: "switch_machine_test2",
                    node_id: this.runArr[2].id,
                    node_name: this.runArr[2].name,
                    component_id: "split_datasets",
                    component_name: this.runArr[2].name,
                    node_params: {
                        split_prop: this.runArr[2].form[0].data[0].value
                            .node_params.split_prop
                    },
                    edge_in: ["input_data_standard_scale>dataset_path"],
                    edge_out: [
                        "train_data>train_csv_path",
                        "test_data>test_csv_path"
                    ],
                    input: this.runArr[1].output,
                    pre_run_uuids: [this.runArr[1].artifact_path],
                    is_generate_model: "false"
                })
                .then(res => {
                    this.currentNodeNum++;
                    if (res.data.code === 200) {
                        ...
                        this.runArr[2].output = res.data.output;
                        this.runArr[2].artifact_path = res.data.run_uuid;
                        this.$message.success("拆分运行成功");
                        this.$message.success(
                            this.runArr[this.currentNodeNum - 1].name
                        );
                        this.runAto4();
        ...
        runAto4() {
            this.$api
                .post(POST_RUN_MODEL, {
                    ...
                    experiment_id: this.data_test_id + "",
                    experiment_name: "switch_machine_test2",
                    node_id: this.runArr[3].id,
                    node_name: this.runArr[3].name,
                    component_id: "reg_knn",
                    component_name: this.runArr[3].name,
                    node_params: {
                        select_features_columns: this.runArr[3].form[0].data[0].value.node_params.select_features_columes.join(
                            ","
                        ),
                        select_target_columns: this.runArr[3].form[0].data[1].value.node_params.select_target_columes.join(
                            ","
                        ),
                        n_neighbors: this.runArr[3].form[1].data[0].value
                    },
                    edge_in: ["train_data>train_csv_path"],
                    edge_out: ["reg_knn_model>model_path"],
                    input: {
                        train_csv_path: this.runArr[2].output.train_csv_path
                    },
                    pre_run_uuids: [this.runArr[2].artifact_path],
                ...
                .then(res => {
                    ...
                    if (res.data.code === 200) {
                        ...
                        this.runArr[3].output = res.data.output;
                        this.runArr[3].artifact_path = res.data.run_uuid;
                        this.$message.success(
                            this.runArr[this.currentNodeNum - 1].name
                        );
                        this.runAto5();
                        ...
                        this.$api
                            .post(POST_ADD_MODEL_DATA, {
                                data_user_id: localStorage.getItem(
                                    "data_user_id"
                                ),
                                model_name: this.currentTest.test_name, //
                                model_describe: this.currentTest.test_content,
                                model_test_name: this.currentTest.test_name,
                                model_only_name: res.data.model_name,
                                model_versions_id: res.data.model_version,
                                model_run_uuid: res.data.run_uuid
                            })
                            .then(res => {
                                // 将模型id 保存至节点
                                // this.runArr[3].saveId = "6";
                                this.runArr[3].saveId = res.data.model_id;
        ...
        runAto5() {
            let inputObj = Object.assign(
                this.runArr[2].output,
                this.runArr[3].output
            );
            delete inputObj.train_csv_path;
            ...
            this.$api
                .post(POST_RUN_MODEL, {
                    ...
                    experiment_id: this.data_test_id + "",
                    experiment_name: "switch_machine_test2",
                    node_id: this.runArr[4].id,
                    node_name: this.runArr[4].name,
                    component_id: this.runArr[4].component_id,
                    component_name: this.runArr[4].name,
                    node_params: {
                        select_features_columns: this.runArr[3].form[0].data[0].value.node_params.select_features_columes.join(
                            ","
                        ),
                        ...
                        predict_target_columns: this.runArr[4].form[0].data[0]
                            .value
                    },
                    edge_in: [
                        "test_data>test_csv_path",
                        "reg_knn_model>model_path"
                    ],
                    edge_out: ["test_result>test_data_predict"],
                    input: inputObj,

                    // input: {
                    //     test_csv_path: this.runArr[2].output,
                    //     model_path: this.runArr[3].output
                    // },
                    pre_run_uuids: [
                        this.runArr[2].artifact_path,
                        this.runArr[3].artifact_path
                    ],
                    is_generate_model: "false"
                })
                .then(res => {
                    ...
                    console.log(res);
                    if (res.data.code === 200) {
                        this.runArr[4].output = res.data.output;
                        this.runArr[4].artifact_path = res.data.run_uuid;
                        console.log("查看当前待执行数据", this.runArr);
                        this.changeNodeStatus(
                            res.data.node_id,
                            res.data.start_time,
                            res.data.end_time
                        );
                        this.$message.success("模型测试运行成功");
                        this.runAto6();
                    }
                });
        },
        runAto6() {
            this.$api
                .post(POST_RUN_MODEL, {
                    ...
                    experiment_id: this.data_test_id + "",
                    experiment_name: "switch_machine_test2",
                    node_id: this.runArr[5].id,
                    node_name: this.runArr[5].name,
                    component_id: "regressor_eval",
                    component_name: this.runArr[5].name,
                    node_params: {
                        original_target_columns: this.runArr[3].form[0].data[1].value.node_params.select_target_columes.join(
                            ","
                        ),
                        predict_target_columns: "prediction_result"
                    },
                    edge_in: ["test_result>test_data_predict"],
                    edge_out: [],
                    input: {
                        test_data_predict: this.runArr[4].output
                            .test_data_predict
                    },
                    pre_run_uuids: [this.runArr[4].artifact_path],
                    is_generate_model: "false"
                })
                .then(res => {
                    this.loading.close();
        ...
        deploy2() {
            ...
            this.$api
                .post(POST_RUN_MODEL, {
                    ...
                    component_name: this.runArr[1].name,
                    node_params: {
                        split_prop: this.runArr[1].form[0].data[0].value
                            .node_params.split_prop
                    },
                    edge_in: ["csv_path>dataset_path"],
                    edge_out: [
        ...
        deploy3() {
            ...
            this.$api
                .post(POST_RUN_MODEL, {
                    ...
                    component_name: this.runArr[2].name,
                    node_params: {
                        select_features_columns: this.runArr[2].form[0].data[0].value.node_params.select_features_columes.join(
                            ","
                        ),
                        select_target_columns: this.runArr[2].form[0].data[1].value.node_params.select_target_columes.join(
                            ","
                        ),
                        n_neighbors: this.runArr[2].form[1].data[0].value
                            .node_params.n_neighbors
                    },
                    edge_in: ["train_data>train_csv_path"],
                    edge_out: ["cla_knn_model>model_path"],
                    input: {
                        train_csv_path: this.runArr[1].output.train_csv_path
                    },
                    pre_run_uuids: this.runArr[1].artifact_path,
                    is_generate_model: "true"
                })
        ...
        deploy4() {
            ...
            this.$api
                .post(POST_RUN_MODEL, {
                    ...
                    edge_in: [
                        "test_data>test_csv_path",
                        "cla_knn_model>model_path"
                    ],
                    edge_out: ["test_result>test_data_predict"],
                    input: {
                        test_csv_path: this.runArr[1].output.test_csv_path,
                        model_path: this.runArr[2].output.model_path
                    },
                    pre_run_uuids: [
                        this.runArr[1].artifact_path[0],
                        this.runArr[2].artifact_path
                    ],
                    is_generate_model: "false"
                })
        ...
        deploy5() {
            ...
            this.$api
                .post(POST_RUN_MODEL, {
                    ...
                    node_id: this.runArr[4].id,
                    node_name: this.runArr[4].name,
                    component_id: "classifier_eval",
                    component_name: this.runArr[4].name,
                    node_params: {
                        original_target_columns: this.runArr[2].form[0].data[1].value.node_params.select_target_columes.join(
                            ","
                        ),
                        predict_target_columns: "prediction_result"
                    },
                    ...
                    edge_out: [],
                    input: {
                        test_data_predict: this.runArr[3].output
                            .test_data_predict
                    },
                    pre_run_uuids: [this.runArr[3].artifact_path],
                    is_generate_model: "false"
                })
                .then(res => {
                    this.loading.close();
